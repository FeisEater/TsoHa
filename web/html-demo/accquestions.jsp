                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td width="15%">4</td>
                                <td width="5%"><button type="button" class="btn btn-xs btn-default center-block"><span class="glyphicon glyphicon-arrow-left"></span></button></td>
                            </tr>
                            <tr>
                                <td>What's the meaning of life?</td>
                                <td>42</td>
                                <td><button type="button" class="btn btn-xs btn-default center-block"><span class="glyphicon glyphicon-arrow-left"></span></button></td>
                            </tr>
                            <tr>
                                <td>How do I read?</td>
                                <td>12</td>
